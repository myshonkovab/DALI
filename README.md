...
*/
/*
Текстовик (каждое время задается в секундах, яркости - задаются как массив из 6 чисел, где первое число равно 0):
- TimeAero(1) 7200       // 2*60 (2ч)
- TimeNotAero(1) 7200    // 2*60 (2ч)
- brightRed(6) 0,254,254,254,254,254
- brightBlue(6) 0,0,0,0,0,0
